...
function generatePropositions(concept, relationships, mechanism) {
    const propositions = [];
...
function getPropositionTypeKorean(type) {
    const typeMap = {
        antecedent: "선행요인 명제",
        outcome: "결과요인 명제",
        mechanism: "메커니즘 명제",
...
function createTheoreticalModel(concept, propositions) {
...
function getPropositionChecklist() {
    return {
...
function getPropositionExamples() {
    return [
...
//# sourceMappingURL=developProposition.js.map