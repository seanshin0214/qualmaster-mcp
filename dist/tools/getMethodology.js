...
function getSampleSizeRecommendation(methodology) {
...
function getDataCollectionMethods(methodology) {
    const methods = {
...
function getAnalysisApproach(methodology) {
    const approaches = {
...
//# sourceMappingURL=getMethodology.js.map